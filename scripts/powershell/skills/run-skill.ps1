...
$root = Resolve-Root
$startTaskScript = Join-Path $scriptsRoot "powershell\bootstrap\start-task.ps1"
$orchestrationScript = Join-Path $scriptsRoot "run-orchestration.ps1"
$sessionGuardScript = Join-Path $scriptsRoot "run-session-guard-checks.ps1"

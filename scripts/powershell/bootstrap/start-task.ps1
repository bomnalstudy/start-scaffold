...
$contextBuilder = Join-Path $scriptsRoot "powershell\context\build-project-context.ps1"
try {
...
$sessionGuardChecker = Join-Path $scriptsRoot "run-session-guard-checks.ps1"
...
$tokenOpsChecker = Join-Path $scriptsRoot "run-token-ops-checks.ps1"

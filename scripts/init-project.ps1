...
Write-Host "2. Run .\scripts\export-project-secrets.ps1 -Profile $profile"
Write-Host "3. Run .\scripts\load-project-secrets.ps1 -Profile $profile"
Write-Host "4. Read AGENTS.md and docs\workflow.md"
Write-Host "5. Archive retired files with .\scripts\archive-to-graveyard.ps1"

...
$doc.Add("")
$doc.Add("_Generated automatically by `scripts/build-project-context.ps1` at $generatedAt._")
$doc.Add("")
$doc.Add("## Project")
$doc.Add("")
...
$compact.Add("")
$compact.Add("_Generated automatically by `scripts/build-project-context.ps1` at $generatedAt._")
$compact.Add("")

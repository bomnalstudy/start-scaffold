...
- Current standard modes are `ux-ui-mode`, `secure-mode`, `optimize-mode`, `db-mode`, `code-refactor-mode`, `orchestrator-mode`, `harness-mode`, and `failure-pattern-mode`.
...
- Repo-local mode skills such as `ux-ui-mode`, `secure-mode`, `optimize-mode`, `db-mode`, `orchestrator-mode`, `harness-mode`, and `failure-pattern-mode` are agent-neutral and can be used from both Claude and Codex.
